...
# ---------------------------------------------------------------- Streamlit UI
st.set_page_config(page_title="LexAssist LGPD Demo", page_icon=":robot:", layout="centered")

st.title(":robot: LexAssist LGPD")
st.caption(
    "Assistente RAG especializado em LGPD para desenvolvedores e arquitetos de software: "
    "responde perguntas de compliance citando os artigos exatos da lei, reduzindo alucinações "
    "e acelerando decisões seguras sobre tratamento de dados."
)
...
st.divider()
st.caption(
    "Consulte o README do projeto para problem statement, arquitetura, custo/latency e decisões de design."
)
